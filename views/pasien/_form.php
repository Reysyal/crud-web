<section class="flex justify-center">
    <div class="py-6 bg-white w-11/12 md:w-2/4 lg:w-2/5 xl:w-[30%]">
        <h2 class="mb-2 text-3xl font-bold tracking-tight px-6 text-red-600">Tambah Pasien</h2>
        <form method="POST">
            <hr class="my-5" />
            <div class="mb-6 px-6">
            ...
            <button type="submit" class="focus:outline-none text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-7 py-2.5 mb-2 mx-6">Tambah Pasien</button>
        </form>
    </div>
</section>